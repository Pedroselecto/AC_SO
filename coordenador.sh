...
# Definimos os caminhos completos uma vez aqui
...
# Usamos as variáveis com os caminhos completos
...
elif [ "$USER" == "coordenador" ]; then # ATUALIZADO DE 'professor' PARA 'coordenador'
    menu_coordenador
